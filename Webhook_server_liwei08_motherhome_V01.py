...
#-----------買進
    ...
    # pyautogui.moveTo(x=1480, y=959,duration=5)
    # pyautogui.click(x=1480, y=959) 
    # pyautogui.click((pyautogui.locateCenterOnScreen(
...
#-----------賣出
    ...
    pyautogui.press('down',interval=1.5) 
    #pyautogui.click((pyautogui.locateCenterOnScreen('C:/Users/Liwei/python-imagesearch/firstrade_05.png')),interval=1.5)
    pyautogui.moveTo(1480, 959,duration=2)
    pyautogui.click(1480, 959) 
    # pyautogui.click((pyautogui.locateCenterOnScreen(
...
def init_stock_web():
    ...
    pyautogui.click(166,23)
    #pyautogui.click(1154,1003)
    pyautogui.click(162,1099)
    ...
    pyautogui.click(516, 200,interval=0.5) 
      
    
    # pyautogui.click((pyautogui.locateCenterOnScreen(
    #     'C:/Users/Liwei/python-imagesearch/firstrade_01.png')),interval=1)
    pyautogui.click(824, 287,interval=0.5)
    # # pyautogui.click((pyautogui.locateCenterOnScreen(
